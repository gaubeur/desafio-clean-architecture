...
func (ec *executionContext) field_Mutation_createOrder_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	var err error
	args := map[string]any{}
	arg0, err := graphql.ProcessArgField(ctx, rawArgs, "input", ec.unmarshalNNewOrder2githubᚗcomᚋgaubeurᚋdesafioᚑposgraduacaoᚑgolangᚑfullcycleᚋdesafioᚑcleanᚑarchitectureᚋgraphᚋmodelᚐNewOrder)
	if err != nil {
		return nil, err
	}
	args["input"] = arg0
...
func (ec *executionContext) _Mutation_createOrder(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNOrder2ᚖgithubᚗcomᚋgaubeurᚋdesafioᚑposgraduacaoᚑgolangᚑfullcycleᚋdesafioᚑcleanᚑarchitectureᚋgraphᚋmodelᚐOrder(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Order_product_name(ctx context.Context, field graphql.CollectedField, obj *model.Order) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Order_product_name(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
...
func (ec *executionContext) _Query_orders(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.Order)
	fc.Result = res
	return ec.marshalNOrder2ᚕᚖgithubᚗcomᚋgaubeurᚋdesafioᚑposgraduacaoᚑgolangᚑfullcycleᚋdesafioᚑcleanᚑarchitectureᚋgraphᚋmodelᚐOrderᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalInputNewOrder(ctx context.Context, obj any) (model.NewOrder, error) {
	...
	fieldsInOrder := [...]string{"customer_name", "product_name", "quantity"}
...
func (ec *executionContext) unmarshalNNewOrder2githubᚗcomᚋgaubeurᚋdesafioᚑposgraduacaoᚑgolangᚑfullcycleᚋdesafioᚑcleanᚑarchitectureᚋgraphᚋmodelᚐNewOrder(ctx context.Context, v any) (model.NewOrder, error) {
	res, err := ec.unmarshalInputNewOrder(ctx, v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) marshalNOrder2githubᚗcomᚋgaubeurᚋdesafioᚑposgraduacaoᚑgolangᚑfullcycleᚋdesafioᚑcleanᚑarchitectureᚋgraphᚋmodelᚐOrder(ctx context.Context, sel ast.SelectionSet, v model.Order) graphql.Marshaler {
	return ec._Order(ctx, sel, &v)
}

func (ec *executionContext) marshalNOrder2ᚕᚖgithubᚗcomᚋgaubeurᚋdesafioᚑposgraduacaoᚑgolangᚑfullcycleᚋdesafioᚑcleanᚑarchitectureᚋgraphᚋmodelᚐOrderᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Order) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNOrder2ᚖgithubᚗcomᚋgaubeurᚋdesafioᚑposgraduacaoᚑgolangᚑfullcycleᚋdesafioᚑcleanᚑarchitectureᚋgraphᚋmodelᚐOrder(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNOrder2ᚖgithubᚗcomᚋgaubeurᚋdesafioᚑposgraduacaoᚑgolangᚑfullcycleᚋdesafioᚑcleanᚑarchitectureᚋgraphᚋmodelᚐOrder(ctx context.Context, sel ast.SelectionSet, v *model.Order) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
